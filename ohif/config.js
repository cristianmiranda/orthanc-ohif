...
window.config = {
    ...
    defaultDataSourceName: 'localOrthancServer',
    ...
    dataSources: [
        {
            ...
            sourceName: 'localOrthancServer',
            configuration: {
                friendlyName: 'Local Orthanc Server',
                name: 'Orthanc',
                qidoRoot: 'http://localhost:3080/dicom-web', // Matches the Nginx location block
                wadoRoot: 'http://localhost:3080/dicom-web', // Matches the Nginx location block
                wadoUriRoot: 'http://localhost:3080/dicom-web', // Matches the Nginx location block
                ...
                defaultQueryParams: {
                    since: '0', // Ensures Orthanc receives the required "since" parameter
                    limit: '10', // Ensures Orthanc receives the required "limit" parameter
                },
            },
        },
        {
